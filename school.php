...
<html>
  ...
  <body class="container" style="padding-bottom:32px;">
    ...
    <h1 class="title">BC Computing Olympiad</h1>
      <a href="https://www.bcco-inovaca.org" style="text-decoration: none; text-align: left;">
      <button class="btn btn-default" style=" display: block; cursor: pointer;">Logout</button>
    </a>
